    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe keyframe_start = Keyframe.ofFloat(0f, 0f);
                Keyframe keyframe_middle = Keyframe.ofFloat(0.5f, 100f);
                Keyframe keyframe_end = Keyframe.ofFloat(1f, 80f);
                PropertyValuesHolder propertyValuesHolder = PropertyValuesHolder.ofKeyframe("progress", keyframe_start, keyframe_middle, keyframe_end);
