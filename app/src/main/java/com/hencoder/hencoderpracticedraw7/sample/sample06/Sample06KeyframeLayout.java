    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Keyframe keyframe1 = Keyframe.ofFloat(0f, 0f); // 开始：progress 为 0
                Keyframe keyframe2 = Keyframe.ofFloat(0.5f, 100f); // 进行到一半是，progres 为 100
                Keyframe keyframe3 = Keyframe.ofFloat(1f, 80f); // 结束时倒回到 80
